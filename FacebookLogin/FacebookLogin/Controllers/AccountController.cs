        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
         //   var loginInfo = await AuthenticationManager.GetExternalLoginInfoAsync()
            ...
            if (loginInfo == null)
            {
             ...
             var signResult = await SignInManager.ExternalSignInAsync(loginInfo, isPersistent: false);
            switch (signResult)
            {
                case SignInStatus.Success:
                    return RedirectToAction("Index", "Home");
            ...
            var facebookUrl = loginInfo.ExternalIdentity.Claims.First(c => c.Type == "urn:facebook:link").Value;
